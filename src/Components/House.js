  ...
  return (
    <main className="flex h-screen w-[94dvw] right-0 absolute overflow-x-hidden">
      ...
      >
        ...
        <div>
          ...
          <div className="bg-white p-4 mb-4 rounded-lg shadow-md">
            <img src='/assets/house1.jpg' alt="house" className="w-full h-32 object-cover rounded-md" />
            <h3 className="text-xl font-semibold mt-2">Cabinet</h3>
            <p className="text-gray-600">1.5 EcoBlue MT Titanium X</p>
            <p className="text-gray-800 font-semibold">$1140.00 / day</p>
          </div>
           
          <div className="bg-white p-4 mb-4 rounded-lg shadow-md">
            <img src='/assets/house3.jpg' alt="Car" className="w-full h-32 object-cover rounded-md" />
            <h3 className="text-xl font-semibold mt-2">Mountain ...</h3>
            <p className="text-gray-600">1.5 EcoBlue MT Titanium X</p>
            <p className="text-gray-800 font-semibold">$804.00 / hour</p>
          </div>
      ...
      >
        ...
        <div>
          <img src='/assets/house4.jpg' alt="Car Detail" className="w-full h-32 object-cover rounded-md" />
          <h2 className="text-lg font-semibold mt-2">Bunglow</h2>
          <p className="text-gray-600">1.5 EcoBlue ST-Line Style 115CV</p>
          <p className="text-gray-800 font-semibold">$2800.00 / hour</p>
